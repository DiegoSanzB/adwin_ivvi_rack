...
'<Header End>
' i_measure: records readings of voltage on MUX1 and MUX2
...
DIM DATA_50[1048576] as long   ' current measurements
DIM DATA_51[1048576] as long   ' voltage measurements
...
EVENT:
  ...
  IF  (avcounter=PAR_55) THEN
    PAR_12=totalcurrent1 / avcounter
    DATA_50[index]=PAR_12
    totalcurrent1=0
    avcounter=0
    INC(index)
  ENDIF
